...
[Preserve]
public class SKILLTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(SKILLTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(SKILLTEXT_TABLE table)
	{
