...
[Preserve]
public class LOCALIZATION_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(LOCALIZATION_TABLE tbl)
	{
	...
	public bool EqualValue(LOCALIZATION_TABLE table)
	{
