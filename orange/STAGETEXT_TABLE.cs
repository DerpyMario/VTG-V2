...
[Preserve]
public class STAGETEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(STAGETEXT_TABLE tbl)
	{
	...
	public bool EqualValue(STAGETEXT_TABLE table)
	{
