...
[Preserve]
public class RANDOMNAME_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(RANDOMNAME_TABLE tbl)
	{
	...
	public bool EqualValue(RANDOMNAME_TABLE table)
	{
