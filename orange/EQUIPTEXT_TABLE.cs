...
[Preserve]
public class EQUIPTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(EQUIPTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(EQUIPTEXT_TABLE table)
	{
