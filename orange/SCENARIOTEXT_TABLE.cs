...
[Preserve]
public class SCENARIOTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(SCENARIOTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(SCENARIOTEXT_TABLE table)
	{
