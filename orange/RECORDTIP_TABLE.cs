...
[Preserve]
public class RECORDTIP_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(RECORDTIP_TABLE tbl)
	{
	...
	public bool EqualValue(RECORDTIP_TABLE table)
	{
