...
[Preserve]
public class HOWTOGETTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(HOWTOGETTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(HOWTOGETTEXT_TABLE table)
	{
