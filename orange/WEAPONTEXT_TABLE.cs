...
[Preserve]
public class WEAPONTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(WEAPONTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(WEAPONTEXT_TABLE table)
	{
