...
[Preserve]
public class WANTEDTEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(WANTEDTEXT_TABLE tbl)
	{
	...
	public bool EqualValue(WANTEDTEXT_TABLE table)
	{
