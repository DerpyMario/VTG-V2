...
[Preserve]
public class CHARATEXT_TABLE : CapTableBase
{
	...
	public Dictionary<int, object> MakeDiffDictionary(CHARATEXT_TABLE tbl)
	{
	...
	public bool EqualValue(CHARATEXT_TABLE table)
	{
